...
${_scripts.keys
    ...
    script = _prependRequiredImports(script);
  ...
  String _prependRequiredImports(String script) {
    var matcher = new RegExp(r'__--(.+)');
    var imports = <String>[];
    script = script.replaceAllMapped(matcher, (m) {
      if (!imports.contains(m[1]))
        imports.add(m[1]);
      return '';
    });
    return '${imports.join('\n')}\n$script';
